...
Olkoon $P = (x, y)$ yksikköympyrän kehäpiste joka muodostaa suunnatun kulman $\alpha$ positiivisen x-akselin kanssa. Olkoon $P' = (1, t)$ pisteiden $O = (0, 0)$ ja $P$ kautta kulkevan suoran ja suoran $x = 1$ leikkauspiste. Tällöin
